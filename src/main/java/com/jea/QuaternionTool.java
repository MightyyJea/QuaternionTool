...
public class QuaternionTool {
    ...
    public static final String MODID = "quaterniontool";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "quaterniontool" namespace
    ...
    // Creates a new Block with the id "quaterniontool:example_block", combining the namespace and path
